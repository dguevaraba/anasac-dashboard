-- Calendario: permisos por tipo de evento
-- reunion → asociado + admin (ver/crear/editar)
-- competencia / entrenamiento → entrenador + admin (gestionar); nadador (solo ver)
-- otro → asociado / entrenador / nadador (ver); asociado / entrenador / admin (gestionar)
